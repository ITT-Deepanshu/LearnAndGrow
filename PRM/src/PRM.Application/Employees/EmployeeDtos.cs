...
public sealed record AddResourceProfileSkillDto(string Name, SkillCategory Category, SkillProficiency Proficiency);
...
public sealed record ResourceProfileSkillDto(
    long Id,
    string Name,
    string Category,
    string Proficiency);
...
public sealed record EmployeeDetailDto(
    ...
    string ManagerName,
    DateTime? JoinedAt,
    IReadOnlyList<ResourceProfileSkillDto> Skills);
